...
class DeveloperLevel extends $pb.ProtobufEnum {
  static const DeveloperLevel MIDDLE =
      DeveloperLevel._(0, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MIDDLE');
  static const DeveloperLevel INTERN =
      DeveloperLevel._(1, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INTERN');
  static const DeveloperLevel JUNIOR =
      DeveloperLevel._(2, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'JUNIOR');
...
class Skill_SkillType extends $pb.ProtobufEnum {
  static const Skill_SkillType OTHER =
      Skill_SkillType._(0, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OTHER');
...
class Contact_ContactType extends $pb.ProtobufEnum {
  static const Contact_ContactType OTHER =
      Contact_ContactType._(0, $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OTHER');
