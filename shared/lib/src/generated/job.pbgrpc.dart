...
class JobServiceClient extends $grpc.Client {
  ...
  static final _$getJob = $grpc.ClientMethod<$1.StringValue, $0.Job>('/job.JobService/GetJob',
      ($1.StringValue value) => value.writeToBuffer(), ($core.List<$core.int> value) => $0.Job.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Job> getJob($1.StringValue request, {$grpc.CallOptions? options}) {
...
abstract class JobServiceBase extends $grpc.Service {
  ...
  JobServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.StringValue, $0.Job>('GetJob', getJob_Pre, false, false,
        ($core.List<$core.int> value) => $1.StringValue.fromBuffer(value), ($0.Job value) => value.writeToBuffer()));
  ...
  $async.Future<$0.Job> getJob_Pre($grpc.ServiceCall call, $async.Future<$1.StringValue> request) async {
  ...
  $async.Future<$0.Job> getJob($grpc.ServiceCall call, $1.StringValue request);
