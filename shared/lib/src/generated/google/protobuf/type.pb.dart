...
class Type extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Type',
      package:
          const $pb.PackageName($core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf'),
      createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..pc<Field>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fields', $pb.PbFieldType.PM,
        subBuilder: Field.create)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oneofs')
    ..pc<Option>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', $pb.PbFieldType.PM,
        subBuilder: Option.create)
    ..aOM<$0.SourceContext>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceContext',
        subBuilder: $0.SourceContext.create)
    ..e<Syntax>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'syntax', $pb.PbFieldType.OE,
  ...
  Type copyWith(void Function(Type) updates) =>
      super.copyWith((message) => updates(message as Type)) as Type; // ignore: deprecated_member_use
...
class Field extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Field',
      package:
          const $pb.PackageName($core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf'),
      createEmptyInstance: create)
    ..e<Field_Kind>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind', $pb.PbFieldType.OE,
        defaultOrMaker: Field_Kind.TYPE_UNKNOWN, valueOf: Field_Kind.valueOf, enumValues: Field_Kind.values)
    ..e<Field_Cardinality>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cardinality', $pb.PbFieldType.OE,
    ...
    ..a<$core.int>(
        7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oneofIndex', $pb.PbFieldType.O3)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packed')
    ..pc<Option>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', $pb.PbFieldType.PM,
        subBuilder: Option.create)
  ...
  Field copyWith(void Function(Field) updates) =>
      super.copyWith((message) => updates(message as Field)) as Field; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Enum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Enum',
      package:
          const $pb.PackageName($core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf'),
      createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..pc<EnumValue>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enumvalue', $pb.PbFieldType.PM,
        subBuilder: EnumValue.create)
    ..pc<Option>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', $pb.PbFieldType.PM,
        subBuilder: Option.create)
    ..aOM<$0.SourceContext>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceContext',
        subBuilder: $0.SourceContext.create)
    ..e<Syntax>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'syntax', $pb.PbFieldType.OE,
        defaultOrMaker: Syntax.SYNTAX_PROTO2, valueOf: Syntax.valueOf, enumValues: Syntax.values)
    ..hasRequiredFields = false;
  ...
  Enum copyWith(void Function(Enum) updates) =>
      super.copyWith((message) => updates(message as Enum)) as Enum; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EnumValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EnumValue',
      package:
          const $pb.PackageName($core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.protobuf'),
      createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  EnumValue copyWith(void Function(EnumValue) updates) =>
      super.copyWith((message) => updates(message as EnumValue)) as EnumValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Option extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$1.Any>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value',
