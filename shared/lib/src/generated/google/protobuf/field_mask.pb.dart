...
class FieldMask extends $pb.GeneratedMessage with $mixin.FieldMaskMixin {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FieldMask',
      package:
  ...
  FieldMask copyWith(void Function(FieldMask) updates) =>
      super.copyWith((message) => updates(message as FieldMask)) as FieldMask; // ignore: deprecated_member_use
